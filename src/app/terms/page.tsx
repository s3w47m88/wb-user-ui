        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              By accessing and using this website builder service
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              Organization creators are responsible for:
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
              <li>Managing member access and permissions</li>
              <li>All content and websites created under the organization</li>
              <li>Compliance with these Terms by all organization members</li>
              <li>
                Payment obligations associated with the organization&apos;s
                usage
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              You retain all rights to the content you create and publish using
              our Service. By uploading content, you grant us a license to
              store, display, and distribute your content solely for the purpose
              of providing the Service to you.
            </p>
            <p className="text-gray-700 mb-4">
              You are solely responsible for the content you publish and the
              consequences of publishing such content. You agree that your
              content will not:
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-4 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              to the collection and use of information as outlined in our
              Privacy Policy.
            </p>
            <p className="text-gray-700 mb-4">
              We implement reasonable security measures to protect your data,
              but we cannot guarantee absolute security. You are responsible for
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              termination, we will make reasonable efforts to provide you with
              access to your content for a limited time.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              <strong>Email:</strong> support@politogy.com
              <br />
